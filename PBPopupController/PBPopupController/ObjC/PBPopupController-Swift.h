...
/// returns:
///
/// <code>false</code> if you want the close button action to be ignored, <code>true</code> otherwise.
- (BOOL)popupController:(PBPopupController * _Nonnull)popupController shouldClose:(UIViewController * _Nonnull)popupContentViewController SWIFT_WARN_UNUSED_RESULT;
/// Called just before the popup content view is about to be closed.
/// \param popupController The popup controller object.
///
/// \param popupContentViewController The popup content view controller object.
